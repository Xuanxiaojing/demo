...
<script>
    ...
    export default{
        ...
        mounted(){
            // console.log(getComputedStyle(this.$refs.musicBox)['paddingLeft'],11111111)
        ...
        methods: {
            ...
            middleTouchEnd() {
                ...
                if (this.currentShow === 'cdImg') { // 如果当前展示cd
                    ...
                    if (this.touch.percent < 0.5) {
                        ...
                        // console.log(-window.innerWidth,33333333333333)
                        opacity = 0
                    }
                }
                // 设置动画缓冲时间
            ...
            play(){                
                ...
                // this.$store.commit('changeListIsplay',{isPlay:!this.$store.state.playState,index:i});             
                // 切换播放/暂停状态
