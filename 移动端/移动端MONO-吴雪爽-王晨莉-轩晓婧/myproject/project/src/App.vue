<template>
  <div id="app">
    ...
    <!-- VUX提示组件 -->
    <toast ref="w" v-model="showPositionValue" type="text" :time="1100" text="师傅，数据被妖怪抓走了" :position="position">{{ $t('Basic Usage') }}</toast>
  </div>
</template>
...
<style>
  ...
  #app .weui-actionsheet__menu,#app .weui-actionsheet{
      width: 46rem;
  }
  #app .weui-actionsheet__menu div{        
      float: left;
      width: 33.33%;
      height: 11.11rem;
